...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query("""
            ...
            """)
    Page<Object[]> findAllByStoreIdWithSlugStore(String slugStore, String name1, String name2, String name3, String name4, String name5, Integer idCate, boolean quantityFilter,
            Pageable pageable);
    ...
    Page<Product> findByNamePrCateTrademark(String name1, String name2, String name3, String name4, String name5,
    ...
    @Query("""
                ...
                GROUP BY p
            """)
    Page<Object[]> queryFindMore(String nameUrl, String name1, String name2, String name3, String name4, String name5,
